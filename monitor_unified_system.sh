...
LOG_DIR="/var/www/advacodex.com/unified_codexes/logs"
STATUS_FILE="/var/www/advacodex.com/unified_codexes/status.json"
...
check_downloaded_files() {
    ...
    CODEXES_DIR="/var/www/advacodex.com/unified_codexes/codexes"
...
check_performance() {
    ...
    DISK_USAGE=$(df -h /var/www/advacodex.com | tail -1 | awk '{print $5}')

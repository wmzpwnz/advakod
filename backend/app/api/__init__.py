...
from .organization import router as organization_router  # Получение данных организаций и банков по ИНН/БИК
from .documents import router as documents_router  # Генерация документов
...
async def health_v1():
    """Liveness probe - проверка что сервер работает (v1 API)"""
    import time
...
api_router.include_router(organization_router, tags=["organization"])  # Получение данных организаций и банков
api_router.include_router(documents_router, tags=["documents"])  # Генерация документов

...
class Settings(BaseSettings):
    ...
    VISTRAL_N_THREADS: int = int(os.getenv("VISTRAL_N_THREADS", "8"))  # Все ядра для мощного железа
    ...
    SECRET_KEY: str = Field(
        default=os.getenv("SECRET_KEY", "DevSecretKey123" + "X" * 50),  # Safe default for dev with uppercase, lowercase, and digits
        min_length=32, 

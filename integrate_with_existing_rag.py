...
class RAGIntegrationManager:
    ...
    def __init__(self):
        ...
        self.chunks_dir = Path("/var/www/advacodex.com/final_system/rag_integration/chunks")
        self.processed_docs_dir = Path("/var/www/advacodex.com/final_system/rag_integration/processed_documents")
    ...
    def create_integration_report(self):
        ...
        # Сохраняем отчет
        report_file = Path("/var/www/advacodex.com/rag_integration_report.json")

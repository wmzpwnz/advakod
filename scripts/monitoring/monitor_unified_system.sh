...
LOG_DIR="/opt/advakod/unified_codexes/logs"
STATUS_FILE="/opt/advakod/unified_codexes/status.json"
...
check_downloaded_files() {
    ...
    CODEXES_DIR="/opt/advakod/unified_codexes/codexes"
...
check_performance() {
    ...
    DISK_USAGE=$(df -h /opt/advakod| tail -1 | awk '{print $5}')
